...
def main():
    ...
    jax_image_left_list = sorted(glob.glob(os.path.join(SOURCE_IMAGES_ROOT, 'JAX*LEFT_RGB.tif')))
    jax_image_right_list = sorted(glob.glob(os.path.join(SOURCE_IMAGES_ROOT, 'JAX*RIGHT_RGB.tif')))
    jax_disp_list = sorted(glob.glob(os.path.join(SOURCE_DISP_ROOT, 'JAX*LEFT_DSP.tif')))
    oma_image_left_list = sorted(glob.glob(os.path.join(SOURCE_IMAGES_ROOT, 'OMA*LEFT_RGB.tif')))
    oma_image_right_list = sorted(glob.glob(os.path.join(SOURCE_IMAGES_ROOT, 'OMA*RIGHT_RGB.tif')))
    oma_disp_list = sorted(glob.glob(os.path.join(SOURCE_DISP_ROOT, 'OMA*LEFT_DSP.tif')))
